...
```
cd existing_repo
git remote add origin https://gitlab.com/velikiykeamil/task-management-system.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/velikiykeamil/task-management-system/-/settings/integrations)
